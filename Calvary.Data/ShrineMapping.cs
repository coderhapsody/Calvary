...
{
    // Shrine
    public partial class ShrineMapping : EntityTypeConfiguration<Shrine>
    {
        public ShrineMapping()
            : this("dbo")
        {
        }
 
        public ShrineMapping(string schema)
        {
            ToTable(schema + ".Shrine");
            HasKey(x => x.Id);
            ...
            Property(x => x.Address).HasColumnName("Address").IsRequired().IsUnicode(false).HasColumnType("varchar").HasMaxLength(100);
