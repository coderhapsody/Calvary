...
{
    // VisitResult
    public partial class VisitResultMapping : EntityTypeConfiguration<VisitResult>
    {
        public VisitResultMapping()
            : this("dbo")
        {
        }
 
        public VisitResultMapping(string schema)
        {
            ToTable(schema + ".VisitResult");
            HasKey(x => x.Id);
