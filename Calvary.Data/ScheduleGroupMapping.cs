...
{
    // ScheduleGroup
    public partial class ScheduleGroupMapping : EntityTypeConfiguration<ScheduleGroup>
    {
        public ScheduleGroupMapping()
            : this("dbo")
        {
        }
 
        public ScheduleGroupMapping(string schema)
        {
            ToTable(schema + ".ScheduleGroup");
            HasKey(x => x.Id);
