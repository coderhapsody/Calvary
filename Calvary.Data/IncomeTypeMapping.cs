...
{
    // IncomeType
    public partial class IncomeTypeMapping : EntityTypeConfiguration<IncomeType>
    {
        public IncomeTypeMapping()
            : this("dbo")
        {
        }
 
        public IncomeTypeMapping(string schema)
        {
            ToTable(schema + ".IncomeType");
            HasKey(x => x.Id);
