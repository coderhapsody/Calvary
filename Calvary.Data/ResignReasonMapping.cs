...
{
    // ResignReason
    public partial class ResignReasonMapping : EntityTypeConfiguration<ResignReason>
    {
        public ResignReasonMapping()
            : this("dbo")
        {
        }
 
        public ResignReasonMapping(string schema)
        {
            ToTable(schema + ".ResignReason");
            HasKey(x => x.Id);
