...
{
    // WorshipType
    public partial class WorshipTypeMapping : EntityTypeConfiguration<WorshipType>
    {
        public WorshipTypeMapping()
            : this("dbo")
        {
        }
 
        public WorshipTypeMapping(string schema)
        {
            ToTable(schema + ".WorshipType");
            HasKey(x => x.Id);
            ...
            Property(x => x.FlagUmum).HasColumnName("FlagUmum").IsRequired().IsUnicode(false).HasColumnType("varchar").HasMaxLength(10);
