...
{
    // BaptizedReason
    public partial class BaptizedReasonMapping : EntityTypeConfiguration<BaptizedReason>
    {
        public BaptizedReasonMapping()
            : this("dbo")
        {
        }
 
        public BaptizedReasonMapping(string schema)
        {
            ToTable(schema + ".BaptizedReason");
            HasKey(x => x.Id);
