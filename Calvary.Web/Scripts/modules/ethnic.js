...
$(function () {
    $("#addEditWindow").kendoWindow(ethnic.getWindowOptions());
    $("#btnAddNew").click(ethnic.addNewClick);
    $("#btnDelete").click(ethnic.deleteClick);
    $("#grid").on("click", ".editRow", ethnic.editClick);
});