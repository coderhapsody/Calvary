...
$(function () {
    $("#addEditWindow").kendoWindow(shrine.getWindowOptions());
    $("#btnAddNew").click(shrine.addNewClick);
    $("#btnDelete").click(shrine.deleteClick);
    $("#grid").on("click", ".editRow", shrine.editClick);
});