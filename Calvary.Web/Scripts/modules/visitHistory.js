...
$(function () {
    $("#addEditWindow").kendoWindow(visitHistory.getWindowOptions());
    $("#btnAddNew").on("click", visitHistory.addNewClick);
    $("#btnDelete").on("click", visitHistory.deleteClick);
    $("#grid").on("click", ".editRow", visitHistory.editClick);
});