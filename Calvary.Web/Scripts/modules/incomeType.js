var incomeType = (function () {
    ...
    return {
        ...
        saveClick: function (e) {
            ...
            var validator = $("#addEditForm").kendoValidator(incomeType.validatorOptions).data("kendoValidator");
...
$(function () {
    $("#addEditWindow").kendoWindow(incomeType.getWindowOptions());
    $("#btnAddNew").click(incomeType.addNewClick);
    $("#btnDelete").click(incomeType.deleteClick);
    $("#grid").on("click", ".editRow", incomeType.editClick);
});