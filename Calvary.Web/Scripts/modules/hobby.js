var hobby = (function () {
    ...
    return {
        ...
        saveClick: function (e) {
            ...
            var validator = $("#addEditForm").kendoValidator(hobby.validatorOptions).data("kendoValidator");
...
$(function () {
    $("#addEditWindow").kendoWindow(hobby.getWindowOptions());
    $("#btnAddNew").click(hobby.addNewClick);
    $("#btnDelete").click(hobby.deleteClick);
    $("#grid").on("click", ".editRow", hobby.editClick);
});