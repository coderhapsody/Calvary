...
$(function () {
    $("#addEditWindow").kendoWindow(worshipType.getWindowOptions());
    $("#btnAddNew").click(worshipType.addNewClick);
    $("#btnDelete").click(worshipType.deleteClick);
    $("#grid").on("click", ".editRow", worshipType.editClick);
});