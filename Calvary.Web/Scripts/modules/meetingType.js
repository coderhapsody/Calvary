...
$(function () {
    $("#addEditWindow").kendoWindow(meetingType.getWindowOptions());
    $("#btnAddNew").click(meetingType.addNewClick);
    $("#btnDelete").click(meetingType.deleteClick);
    $("#grid").on("click", ".editRow", meetingType.editClick);
});