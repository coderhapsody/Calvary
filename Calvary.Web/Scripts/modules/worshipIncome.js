    ...
    return {
        ...
        addNewClick: function (e) {
            ...
            $("#addEditWindow").data("kendoWindow").refresh({
                ...
                data: {
                    worshipId: $("#SelectedWorship_Id").val()
                }
            }).center().open();
        },
...
$(function () {
    $("#addEditWindow").kendoWindow(worshipIncome.getWindowOptions());
    $("#btnAddNew").click(worshipIncome.addNewClick);
    $("#btnDelete").click(worshipIncome.deleteClick);
    $("#grid").on("click", ".editRow", worshipIncome.editClick);
});