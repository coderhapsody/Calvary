...
$(function () {
    $("#addEditWindow").kendoWindow(skill.getWindowOptions());
    $("#btnAddNew").click(skill.addNewClick);
    $("#btnDelete").click(skill.deleteClick);
    $("#grid").on("click", ".editRow", skill.editClick);
});