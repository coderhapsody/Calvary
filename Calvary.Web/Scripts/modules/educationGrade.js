...
$(function () {
    $("#addEditWindow").kendoWindow(eduGrade.getWindowOptions());
    $("#btnAddNew").click(eduGrade.addNewClick);
    $("#btnDelete").click(eduGrade.deleteClick);
    $("#grid").on("click", ".editRow", eduGrade.editClick);
});